...
class _GreetingScreenState extends State<GreetingScreen> {
  ...
  onTapLogin(BuildContext context) {
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => const PhoneInputLogin()));
  }
              ...
              children: [
                ...
                Padding(
                  padding: EdgeInsets.symmetric(
                      horizontal: 30.0 * scaler.widthScaleFactor),
                  child: Text(
                ...
                Padding(
                  padding: EdgeInsets.only(
                      left: 30.0 * scaler.widthScaleFactor,
                      right: 30.0 * scaler.widthScaleFactor),
                  child: SizedBox(
                      ...
                      style: FilledButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(
                              15.0 * scaler.widthScaleFactor),
                        ),
                        padding: EdgeInsets.symmetric(
                            vertical: 12 * scaler.widthScaleFactor),
                      ),
                      child: Text(
                        'Login',
                        style: TextStyle(
